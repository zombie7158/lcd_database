...
<div align="center">
	...
	<form method="POST" action="keyin_review_test.php">
	...
	<!-- ------------------Model-------------------- -->
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				<input type="radio" name="mdl_sr" value="Yes">Yes
				<input type="radio" name="mdl_sr" value="No">No
			</td>
		</tr>
	...
	<!-- ------------------Mechanical-------------------- -->
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				<input type="text" name="me_adz" size="5">"
			</td>
		</tr>
		<tr bgcolor="#FFFFFF">
			<td align="center">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				LCD: <input type="text" name="me_odx" size="5"> x 
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				...
				w/ PCB: <input type="text" name="me_twpcb" size="5">
			</td>
		</tr>
	...
	<!-- ------------------Optical-------------------- -->
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				<input type="text" name="op_lum9" size="5">
			</td>
		</tr>
		<tr bgcolor="#FFFFFF">
			<td align="center">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				White:<input type="text" name="op_ccw" size="5"> 
				Red:<input type="text" name="op_ccr" size="5"><br>
				Green:<input type="text" name="op_ccg" size="5">
				Blue:<input type="text" name="op_ccb" size="5">
			</td>
		</tr>
		<tr bgcolor="#FFFFFF">
			<td align="center">
