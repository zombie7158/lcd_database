...
me_aa_x like'%$me_aa_x%' and
me_aa_y like'%$me_aa_y%' and
...
<div align="center">
	...
	<table align="center" border="1">
		...
		<?php while($record = mysql_fetch_array($result)){ ?>
			<td ><?php echo $record['mdl_update']?></td>
		<?php } ?>
		</tr>
		<!- -----------Project------------- ->
		...
		<?php while($record = mysql_fetch_array($result)){ ?>
			<td>
				X=<?php echo $record['me_aa_x']?>mm<br>
				Y=<?php echo $record['me_aa_y']?>mm
			</td>
		<?php } ?>
		</tr>
		...
		<?php while($record = mysql_fetch_array($result)){ ?>
			<td>
			<?php echo 'White: '. $record['op_ccwx']. ',' .$record['op_ccwy']?><br>
			<?php echo 'Red: '. $record['op_ccrx'] . ',' .$record['op_ccry']?><br>
			<?php echo 'Green: '. $record['op_ccgx']. ',' .$record['op_ccgy']?><br>
			<?php echo 'Blue: '. $record['op_ccbx']. ',' .$record['op_ccby']?>
			</td>
		<?php } ?>
		</tr>
		<tr align="center">
