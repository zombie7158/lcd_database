...
// 搜尋spec資料表，是否有此仁寶料號
$search = mysql_query("SELECT * FROM spec WHERE p_cpn = '" . $_POST['p_cpn']."';", $link_ID);
// 將搜尋結果以陣列方式存入
...
<div align="center">
	...
	<!-- ------------------Optical-------------------- -->
		...
		<tr bgcolor="#FFFFFF">
			...
			<td>
				White: <?php echo $_POST['op_ccw']; ?>
				Red: <?php echo $_POST['op_ccr']; ?><br>
				Green: <?php echo $_POST['op_ccg']; ?>
				Blue: <?php echo $_POST['op_ccb']; ?>
				<input type="hidden" name="op_ccw" value="<?php echo $_POST['op_ccw']?>">
				<input type="hidden" name="op_ccr" value="<?php echo $_POST['op_ccr']?>">
				<input type="hidden" name="op_ccg" value="<?php echo $_POST['op_ccg']?>">
				<input type="hidden" name="op_ccb" value="<?php echo $_POST['op_ccb']?>">
			</td>
		</tr>
		<tr bgcolor="#FFFFFF">
			<td align="center">
